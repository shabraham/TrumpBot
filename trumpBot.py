...
def generateBot(tup): 
	print "Input a three word topic you want Trump to make a comment about: "
	question = raw_input()
	...
	trumpLst.append("\n****** Generating Seeding Sentences Bi-Gram ******\n")
	for i in range(10):
		trumpLst.append(trump_model.biWriterSeed("crooked",25))
		trumpLst.append(trump_model.biWriterSeed("make america",25))
		trumpLst.append(trump_model.biWriterSeed(question,25))
	trumpLst.append("\n****** Generating Seeding Sentences Tri-Gram ******\n")
	for i in range(10):
	...
	trumpLst.append("\n****** Generating Seeding Sentences Quad-Gram ******\n")
	for i in range(10):
		trumpLst.append(trump_model.quadWriterSeed("crooked hillary clinton",25))
		trumpLst.append(trump_model.quadWriterSeed("make america great",25))
		trumpLst.append(trump_model.quadWriterSeed(question,25))
